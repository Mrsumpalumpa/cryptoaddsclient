...
import  Logo from '../../assets/admin/assets/img/blockchain.png'

const Navbar = () => {
  return (
    <nav className="sb-topnav navbar navbar-expand navbar-light bg-light">
            
            <Link className="navbar-brand ps-3" to="/admin/"><img src={Logo} style={{maxWidth:'40px'}} alt=''></img> CryptoAdds</Link>
